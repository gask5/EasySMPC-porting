...
public class ImportCSV extends ImportFile {
    ...
    private char getDelimiter() throws IOException {
        ...
        try {
            r = new BufferedReader(new InputStreamReader(new FileInputStream(getFile()), StandardCharsets.UTF_8));
            ...
            outer:
            while ((countLines < Resources.PREVIEW_MAX_LINES) && (line != null)) {
    ...
    protected String[][] load() throws IOException {
        ...
        // Open
        Iterable<CSVRecord> records = CSVFormat.DEFAULT.withDelimiter(getDelimiter()).parse((new InputStreamReader(new FileInputStream(getFile()), StandardCharsets.UTF_8)));
